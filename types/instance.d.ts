...
> {
  ...
  listen(port: number | string, address: string, backlog: number, callback: (err: Error | undefined, address: string) => void): void;
  listen(port: number | string, address: string, callback: (err: Error | undefined, address: string) => void): void;
  listen(port: number | string, callback: (err: Error | undefined, address: string) => void): void;
  listen(port: number | string, address?: string, backlog?: number): Promise<string>;
  listen(opts: { port: number; host?: string; backlog?: number }, callback: (err: Error | undefined, address: string) => void): void;
